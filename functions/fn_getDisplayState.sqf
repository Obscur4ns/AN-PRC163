...
private _txPowerA = if (isNil "_channelDataA") then {
    -1
} else {
    _channelDataA getVariable ["power",-1]
};

private _txPowerB = if (isNil "_channelDataB") then {
    -1
} else {
    _channelDataB getVariable ["power",-1]
};
