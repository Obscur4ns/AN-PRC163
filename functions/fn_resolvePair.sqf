...
if (missionNamespace getVariable ["UKSF_PRC163_SingleInstancePilot",false]) then {
    /*
        Pilot mode pair ownership comes from the monitor-maintained endpoint
        map. Do not read prc163PrimaryRadio or rescan inventory here: this
        function is used by ACRE interface callbacks and UI refreshes.
    */
